...
<el-upload
    ...
    <el-button slot="trigger" size="small" type="primary">选取文件</el-button>
       ...
       类型 <el-select v-model="defaultTypeId" placeholder="请选择" size="mini" @change="getButtonShow">
            <el-option
    ...
    <el-button style="margin-left: 10px;" size="" type="success" v-show="button.show2"  @click="runJob(36)">运行支付宝拉新v2审批job</el-button>
    <el-button style="margin-left: 10px;" size="" type="success" v-show="button.show3" @click="runJob(38)">运行百度拉新job</el-button>
       <el-button style="margin-left: 10px;" size="" type="success" v-show="button.show5" @click="runJob(48)">迪信通erp门店销量表</el-button>
         <el-button style="margin-left: 10px;" size="" type="success" v-show="button.show6" @click="runJob(51)">百度数据上报整理</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
           ...
           getButtonShow(type_id){
              for(var key in this.button){

                 if(this.button["show"+type_id]!=undefined){
                   if(key == "show"+type_id){
